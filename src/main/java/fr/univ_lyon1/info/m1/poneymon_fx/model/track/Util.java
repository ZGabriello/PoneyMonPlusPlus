...
public class Util {
    ...
    /**
     * Retourne la longueur de l'angle (orienté) pour aller de l1 vers l2, en
     * cas d'ambiguité, renvoie la longueur la plus courte, et cas d'égalité
     * (pour faire un demi-tour), le cas est indéfini, il faut segmenter le
     * virage.
     */
